...
<node TEXT="需额外使用保存功能保存到文件" ID="ID_921827313" CREATED="1664381927063" MODIFIED="1664612944514">
<icon BUILTIN="button_ok"/>
</node>
</node>
...
<node TEXT="保存" ID="ID_992678354" CREATED="1664004494445" MODIFIED="1664612867666">
<icon BUILTIN="flag"/>
...
<node TEXT="账户充值" ID="ID_1374348353" CREATED="1664004529736" MODIFIED="1664612948546">
<icon BUILTIN="button_ok"/>
